...
/**
 * Retrieves the owners of a taxed property from the Diamond database by its roll number.
 * @param mssqlConfig - The configuration for the SQL Server connection.
 * @param rollNumber - The roll number of the taxed property to retrieve owners for.
 * @returns A promise that resolves to the taxed property owners.
 */
export default async function _getTaxedPropertyOwnersByRollNumber(
